...
public sealed class BlockFragmentFadeOut : MonoBehaviour
{
    ...
    /// <summary>
    /// All fragments use the same delay before fading, regardless of whether
    /// they land on the Floor or fall through a hole.
    /// </summary>
    public void PlayByFloorState(
        float newFragmentFadeDelay,
        ...
        float newDespawnBelowY)
    {
        ...
        StartCoroutine(FadeAndDisable(Mathf.Max(0f, newFragmentFadeDelay), fadeDuration));
    }
